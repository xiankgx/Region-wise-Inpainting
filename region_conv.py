...
def region_conv(x_complete, x_missing, mask, name='com_'):
    ...
    x_fusion = tf.concat([x_complete, x_missing], axis=-1)
    x_fusion = tf.pad(x_fusion, [[0, 0], [p3, p3], [p3, p3], [0, 0]],
                      'REFLECT')
    x_fusion = tf.layers.conv2d(x_fusion, shape[-1],
